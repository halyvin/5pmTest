 ...
 */
 ...
 window.onload = function() {
    ...
    whazzappBtn.setAttribute('href', 'whatsapp://send');
    whazzappBtn.setAttribute('data-text', '!!!! Трололо');
    whazzappBtn.setAttribute('class', 'wa_btn wa_btn_s');
    whazzappBtn.setAttribute('style', 'display:none');
    whazzappBtn.innerHTML = '..';
    ...
    (function () {
        ...
        WASHAREBTN.prototype.crBtn = function () {
            ...
            console.log('root',root, WASHAREBTN)
